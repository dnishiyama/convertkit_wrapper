import requests, time, json, bs4, os, pandas as pd, re, pytz, logging, pdb, boto3, matplotlib.pyplot as plt, reverse_geocoder as rg, iso3166, asks, trio, copy, sys
...
async def fetch(url, ck_api, data, headers, results, page):
								...
								results += extract_ck_api_data(ck_api, json_resp)
